...
#include "include/H265VideoFileServerMediaSubsession.hh"
#include "include/H265VideoRTPSink.hh"
#include "include/ByteStreamFileSource.hh"
#include "include/H265VideoStreamFramer.hh"
...
char const *
H265VideoFileServerMediaSubsession::getAuxSDPLine(RTPSink *rtpSink, FramedSource *inputSource) {
...
FramedSource *
H265VideoFileServerMediaSubsession::createNewStreamSource(unsigned /*clientSessionId*/,
                                                          unsigned &estBitrate) {

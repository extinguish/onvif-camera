...
void NV21Transform(const unsigned char *src, const unsigned char *dst, int srcWidth, int srcHeight,
    ...
    int hflip = 0;
    int vflip = 0;
    if ((FLAG_DIRECTION_ROATATION_0 & directionFlag) != 0 ||
        (FLAG_DIRECTION_ROATATION_180 & directionFlag) != 0) {
        rotate = 0;
    } else {
        rotate = 1;
    }
    ...
    if ((FLAG_DIRECTION_ROATATION_0 & directionFlag) != 0 ||
        (FLAG_DIRECTION_ROATATION_90 & directionFlag) != 0) {
        hflip = IS_FLIP_H ? 1 : 0;
        vflip = IS_FLIP_V ? 1 : 0;
    } else {
        if (IS_FLIP_V) {
...
void NV21TOYUV(const unsigned char *src, const unsigned char *dstY, const unsigned char *dstU,
